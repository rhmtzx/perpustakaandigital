                    ...
                    <div class="col-12 col-lg-7 border-right">
                        <div class="d-md-flex align-items-center">
                            ...
                            <div class="ms-md-4 flex-grow-1">
                                ...
                                <a href="/editprofile" class="btn btn-primary"><i class="fadeIn animated bx bx-edit-alt"></i> Edit Profile</a>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-12">
                                                    ...
                                                    <input type="text" name="" class="form-control" id="" aria-describedby="emailHelp" value="{{Auth()->user()->namalengkap}}" readonly>
                                                </div>
                                                <br>
                                                <div class="mb-12">
                                                    <label for="exampleInputEmail1" class="form-label"><h5>Username</h5></label>
                                                    <input type="text" name="" class="form-control" id="" aria-describedby="emailHelp" value="{{Auth()->user()->username}}" readonly>
                                                </div>
                                                <br>
                                                <div class="mb-12">
                                                    <label for="exampleInputEmail1" class="form-label"><h5>Alamat</h5></label>
                                                    <input type="text" name="" class="form-control" id="" aria-describedby="emailHelp" value="{{Auth()->user()->alamat}}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-12">
