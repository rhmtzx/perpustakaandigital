							...
							<div class="col-xl-6">
								<div class="card-body p-md-5">	
									<div class="text-center">
										...
										<h3 class="mt-4 font-weight-bold"><em>Register Siswa Perpustakaan</em></h3>
									</div>
									<div class="">
										<br>
										<div class="form-body">
											<form action="/prosesregistersiswa" method="post" class="row g-3">
												@csrf
												<div class="col-sm-12">
												...
												<div class="col-sm-12">
													...
													<input type="text" name="username" class="form-control" id="username" placeholder="Rahmatskuy">
												</div>
												<div class="col-sm-12">
												...
												<div class="col-12">
													...
													<input type="email" name="email" class="form-control" id="email" placeholder="rahmatskuy@gmail.com">
												</div>
												<div class="col-12">
