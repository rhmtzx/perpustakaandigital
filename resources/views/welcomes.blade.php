                            ...
                            <div class="card radius-15 bg-success">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div>
                                            <h2 class="mb-0 text-white">{{$peminjamensiswa}}<i class='bx bxs-up-arrow-alt font-14 text-white'></i> </h2>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-auto font-14 text-white">{{$peminjamensiswa}}<i class='bx bxs-up-arrow-alt font-14 text-white'></i></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-lg-4">
                            <div class="card radius-15 bg-primary-blue">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div>
                                            <h2 class="mb-0 text-white">{{$koleksisiswa}}<i class='bx bxs-up-arrow-alt font-14 text-white'></i> </h2>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-auto font-14 text-white">{{$koleksisiswa}}<i class='bx bxs-up-arrow-alt font-14 text-white'></i></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-lg-4">
                            <div class="card radius-15 bg-wall">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div>
                                            <h2 class="mb-0 text-white">{{$ulasansiswa}} <i class='bx bxs-up-arrow-alt font-14 text-white'></i> </h2>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-auto font-14 text-white">{{$ulasansiswa}}<i class='bx bxs-up-arrow-alt font-14 text-white'></i></div>
                                    </div>
                                </div>
                            </div>
                        </div>
