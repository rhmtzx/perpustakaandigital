                ...
                <div class="container">
                    ...
                    <div class="breadcrumb-title pe-3">Data Admin</div>
						...
						<div class="card">
                            <div class="card-body">
                                <div>
                                    <h4><em>DATA SELURUH ADMIN</em></h4>
                                    <hr>
                                    <a href="/register" class="btn btn-primary mb-10">Tambah Akun Admin +</a>
                                    <br></br>
                                    <div class="row" > 
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="/deleteadmin/{{ $row->id }}" class="btn btn-danger"><i class="fadeIn animated bx bx-trash-alt"></i></a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                    </tbody>
