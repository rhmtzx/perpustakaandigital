					...
					<div class="card radius-15 overflow-hidden">
						<div class="row g-0">
							<div class="col-xl-6">
								<div class="card-body p-md-5">
									<div class="text-center">
										...
										<h3 class="mt-4 font-weight-bold"><em>Register Petugas Perpustakaan</em></h3>
									</div>
									<div class="">
										<br>
										<div class="form-body">
											<form action="/prosesregisterpetugas" method="post" class="row g-3">
												@csrf
												<div class="col-sm-12">
													<label for="inputFirstName" class="form-label">Masukkan Nama Lengkap</label>
													<input type="text" name="namalengkap" class="form-control" id="namalengkap" placeholder="Narendra Syahrafli">
												</div>
												<div class="col-sm-12">
													<label for="inputFirstName" class="form-label">Masukkan Username</label>
													<input type="text" name="username" class="form-control" id="username" placeholder="rapliskuy">
												</div>
												<div class="col-sm-12">
													<label for="inputFirstName" class="form-label">Masukkan Alamat</label>
													<input type="text" name="alamat" class="form-control" id="alamat" placeholder="JL. Veteran">
												</div>
												<div class="col-12">
													<label for="inputemailAddress" class="form-label">Masukkan Email</label>
													<input type="email" name="email" class="form-control" id="email" placeholder="rapliskuy@gmail.com">
												</div>
												<div class="col-12">
							...
							<div class="col-xl-6 bg-login-color d-flex align-items-center justify-content-center">
								<img src="{{asset('syndash/codervent.com/syndash/demo/vertical/assets/images/login-images/register-frent-img.jpg')}}" class="img-fluid">
							</div>
						</div>
					</div>
				</div>
