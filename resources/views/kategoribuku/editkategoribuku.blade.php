                    ...
                    <div class="breadcrumb-title pe-3">Kategori Buku</div>
						...
						<div class="card">
                            <div  class="card-body">
                                ...
                                <br>
                                <form action="/updatekategoribuku/{{ $data->id }}" method="POST" enctype="multipart\form-data" >
                                    @csrf
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label"><h5>Update Kategori Buku</h5></label>
                                        <input type="text" name="namakategori" class="form-control" id="namakategori" aria-describedby="emailHelp" value="{{ $data->namakategori }}">
                                    </div>
                                    <br>
