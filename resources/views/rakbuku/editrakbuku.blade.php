                    ...
                    <div class="breadcrumb-title pe-3">Rak Buku</div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Update Rak Buku</li>
                            </ol>
                        </nav>
                    	</div>
                	</div>
						<div class="card">
                            <div  class="card-body">
                                ...
                                <br>
                                <form action="/updaterakbuku/{{ $data->id }}" method="POST" enctype="multipart\form-data" >
                                    @csrf
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label"><h5>Update Rak Buku</h5></label>
                                        <input type="text" name="namarak" class="form-control" id="namarak" aria-describedby="emailHelp" value="{{ $data->namarak }}">
                                    </div>
                                    <br>
